    ...
    <>
      ...
      <main>
        ...
        >
          <AppShell.Header>
            <Flex style={{ height: '100%' }} align="center" justify="space-between">
              <Flex ml="lg">
                ...
                <Title size="h3">SportsMailPro | {props.title}</Title>
              </Flex>
          ...
          <AppShell.Footer>
            <Text ta="right" pr="sm">
              <a href="https://github.com/SIR-Sports-Tech/SportsMailPro">GitHub</a> | <a href="https://ko-fi.com/wweb_dev">Sports Industry Radar</a>
            </Text>
          </AppShell.Footer>
